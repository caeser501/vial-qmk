...
// visualize mute in discord by setting this bool when mute key (pause) is pressed
bool _isMuted = false;

#define KC_AOSW LCTL(KC_F24)
...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        _______, KC_MYCM, KC_WHOM, KC_CALC, KC_MSEL, KC_MPRV, KC_MPLY, KC_MNXT, KC_MSTP, KC_VOLD, KC_MUTE, KC_VOLU, _______, _______,          RGB_TOG,
        _______, RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW, RGB_M_SN, _______, _______, _______, _______, _______, _______, _______, RESET,          KC_AOSW,
        _______, RGB_MOD, RGB_HUI, RGB_SAI, RGB_SPI, RGB_VAI, _______, _______, _______, _______, _______, _______, _______,                   _______,
        _______, RGB_RMOD, RGB_HUD, RGB_SAD, RGB_SPD, RGB_VAD, _______, _______, _______, _______, _______, _______, _______, _______,         _______,
        _______, _______, _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______,          _______, KC_PGUP, _______,
        _______, KC_WINLCK, _______,                            _______,                            _______, _______, MO(2), KC_HOME, KC_PGDN, KC_END
    ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case KC_PAUS:
            if (record->event.pressed) {
                _isMuted = !_isMuted; //toggle status
            }
            return true;
        default:
    ...
    void rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
        ...
        if (_isMuted) {
            rgb_matrix_set_color(LED_PRT, RGB_RED); //light up key when muted
        }
